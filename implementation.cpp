...
public:
    ...
    {
        arr[pos] = val;
        cout << "value changed at this " << pos << endl;
    }
    void display()
    {
...
int main()
{
    ...
    do
    {
        cout << "what operation do you want to perform? select operation number. enter 0 to exist."
             << endl;
        cout << "1. push()" << endl;
        cout << "2. pop()" << endl;
        cout << "3. isEmpty()" << endl;
        ...
        case 4:
            ...
            break;
        case 5:
            cout << "enter pos of item you want to peek." << endl;
            cin >> position;
            cout << "peek funtion called- value at position " << position << " is " << s1.peek(position) << endl;
            break;
        case 6:
            cout << "count funtion called -number of item in stack are:" << s1.count() << endl;
            break;
        case 7:
            cout << "changed funtion called-" << endl;
